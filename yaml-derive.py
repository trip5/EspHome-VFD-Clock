...
#
# Example:
#     python yaml-derive.py EHVClock-HA.yaml "LGLV16 Clock" EHLClock-16-HA.yaml
#
# The script will search the input file looking for lines like...
#
# VFD Clock: Keep next x lines... this will count next x lines below and delete them (because not part of the current label)
# LGLV16 Clock: Uncomment next x lines.. this will count next x lines below and remove the '#' character if it is in the first column
# LGLV16 Clock: Delete next x lines.. this will count next x lines below and delete them
#
...
#
# python yaml-derive.py EHVClock.yaml "LGLV16 Clock" EHVClock_LGLV16.yaml
# python yaml-derive.py EHVClock-HA.yaml "LGLV16 Clock" EHVClock_LGLV16-HA.yaml
